...
<text x="1095" y="720" class="t dark" font-size="13" font-weight="800" text-anchor="end">۳. کنترل سند و ابعاد</text>
<rect x="1030" y="748" width="62" height="28" rx="14" fill="#d9e1ec"/><circle cx="1045" cy="762" r="11" fill="#fff"/>
<text x="1005" y="766" class="t dark" font-size="11" text-anchor="end">حساب گروه است و سند نمی‌پذیرد</text>
<rect x="1030" y="792" width="62" height="28" rx="14" fill="#155bd7"/><circle cx="1077" cy="806" r="11" fill="#fff"/>
<text x="1005" y="810" class="t dark" font-size="11" text-anchor="end">تفصیلی شناور برای این حساب الزامی است</text>
<rect x="1030" y="836" width="62" height="28" rx="14" fill="#155bd7"/><circle cx="1077" cy="850" r="11" fill="#fff"/>
<text x="1005" y="854" class="t dark" font-size="11" text-anchor="end">مرکز هزینه از شعبه پیشنهاد شود</text>
<rect x="1030" y="880" width="62" height="28" rx="14" fill="#d9e1ec"/><circle cx="1045" cy="894" r="11" fill="#fff"/>
<text x="1005" y="898" class="t dark" font-size="11" text-anchor="end">غیرفعال</text>
"@
